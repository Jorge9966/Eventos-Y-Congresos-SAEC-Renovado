...
-- Tiempo de generación: 11-11-2025 a las 17:48:57
...
(2, 'pbkdf2_sha256$1000000$9qDquGFQXSHiZ4p5gKI4nN$GDZSq3Y9dUGBMJ9JWcrKy8wSpgRRpLxZ1FibDqB21ho=', '2025-11-11 16:51:36.190786', 1, 'Jorge', '', '', 'l21070039@valladolid.tecnm.mx', 1, 1, '2025-10-20 20:17:42.000000'),
...
(21, 'pbkdf2_sha256$1000000$nahW5HYnqpi6NfatVhTH1I$EK/ctxzzoo1E44+MCbB37YlRWqZBS4ZNtucjbTvb9wg=', '2025-11-11 16:09:39.818258', 0, 'pootpereztadeoalonso2110@gmail.com', 'Juan', 'Ruiz Matier', 'pootpereztadeoalonso2110@gmail.com', 0, 1, '2025-11-07 04:03:52.319600'),
...
(23, 'pbkdf2_sha256$1000000$NSZw7YHJcoDAGYjjZEuU2l$EWQgYqIH7KzKcxElIqcGZxNI4+vcLix3/orptuExUw0=', '2025-11-11 16:14:53.298842', 0, 'jorge965500@gmail.com', 'Miguel Eduardo', 'Ruiz Matier', 'jorge965500@gmail.com', 0, 1, '2025-11-08 21:30:11.395270'),
(24, 'pbkdf2_sha256$1000000$ypVLCcKbwtuLAsmCgmcxvd$WRRe8StgsFJdyahOjMFS43TyWORY7adTIYgfuidyAVg=', '2025-11-11 16:11:23.690080', 0, 'jorge996650@gmail.com', 'Ana Paula', 'Alonso Cahun', 'jorge996650@gmail.com', 0, 1, '2025-11-11 07:41:48.988073');
...
(8, '@hotmail.com', '2025-10-28 10:42:50.372647', 1),
(10, '@valladolid.tecnm.mx', '2025-11-02 01:23:19.975697', 1),
(11, '@uacam.mx', '2025-11-02 01:23:32.754400', 1),
(12, '@correo.uady.mx', '2025-11-02 01:23:49.244793', 1),
...
(19, '@gmail.com', '2025-11-06 22:39:08.009327', 1),
...
(3, 'Texturas Maximizadas', 'conferencias/istockphoto-924160768-612x612_dLDQaGH.jpg', 'Computo 2', '<p>Buenos dias.</p>\r\n\r\n<p>&nbsp;</p>', '2025-11-11 00:13:52.857947', 4, 23, 60),
(4, 'Recuperacion de nuevas tecnologias.', '', 'Edificio J', '<p>Hola</p>', '2025-11-11 01:40:46.521083', 4, 23, 40),
(5, 'Audicion de año nuevo.', 'conferencias/wallace_BG.png', 'Edificio B', '<p>Buenas noches.</p>', '2025-11-11 01:45:46.910623', 4, 23, 20);
...
CREATE TABLE IF NOT EXISTS `base_congreso` (
  ...
  `access_password_hash` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(1, 'Congreso General', 'congreso-general', '2025-10-28 10:15:16.132371', NULL, NULL, NULL, NULL, 1),
...
(5, 'Pruebas de congresos', 'pruebas-de-congresos', '2025-11-07 23:20:32.707785', 'logos/drawkit-content-man-alt-convertido-de-svg.png', 22, '<p>Buenas noches</p>', 'pbkdf2_sha256$1000000$aTtzRgXOBv3NwhtEVJxzRk$3uGJdmHwoMWse135o1CR0KafOA554XKYPZZOqHs5j5w=', 1);
...
(2, '2025-11-07 23:20:33.352198', 5, 22);
...
CREATE TABLE IF NOT EXISTS `base_extrafield` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `name` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
  `code` varchar(220) COLLATE utf8mb4_unicode_ci NOT NULL,
  `field_type` varchar(12) COLLATE utf8mb4_unicode_ci NOT NULL,
  `required` tinyint(1) NOT NULL,
  `active` tinyint(1) NOT NULL,
  `order` int UNSIGNED NOT NULL,
  `choices_text` longtext COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` datetime(6) NOT NULL,
  `congreso_id` bigint DEFAULT NULL,
  `role_scope` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `base_extrafield` (`id`, `name`, `code`, `field_type`, `required`, `active`, `order`, `choices_text`, `created_at`, `congreso_id`, `role_scope`, `section`) VALUES
(1, 'Matrícula', 'matricula', 'text', 1, 1, 0, 'Blue label', '2025-11-06 23:23:30.328625', 4, 'participante', 'registro'),
(2, 'Genero', 'genero', 'text', 1, 1, 1, '', '2025-11-11 15:57:52.699659', 4, 'both', 'registro');
...
(1, '1° semestre A', '2025-10-28 11:18:15.940001', 1),
...
(1, 'Introducción a la Inteligencia Artificial y Herramientas para desarrollo - Turno Matutino / Dirigido a 1er y 3er', 'talleres/vector-degradado-logotipo-colorido-pajaro_343694-1365.jpg', 'Edificio H', 50, '<p><span style=\"font-size:26px\"><strong><em>mmmmmmmmmmmmmmm mmmmmmmmmmmm mmmmmmmmmm mmm mmmmmmm mmmmmmmm mmmmmmmm mmmmmmmm mmmmmm mmmmm mmmmm mmmmmmm</em></strong></span></p>\r\n\r\n<p><br />\r\n<span style=\"font-size:26px\"><strong><em>Taller 1. Desarrollo Web con Herramientas No Code (Wordpress) Turno Matutino </em></strong></span></p>\r\n\r\n<p><em><strong>Dirigido a 1er y 3er Semestre Lets go</strong></em></p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p><strong>Instructor: Lic. Jes&uacute;s Benjam&iacute;n Yam Aguilar</strong></p>\r\n\r\n<p><a href=\"https://drive.google.com/file/d/1xgVxX28dXEFNLVCNcbGiycjr0FVtdmYX/view?usp=share_link\"><strong>Ver Curr&iacute;culum...</strong></a></p>\r\n\r\n<p><strong>Duraci&oacute;n del Curso: 20 hrs (15 presenciales y 5 No presenciales)</strong></p>\r\n\r\n<p><strong>Horario: 7:30 - 12:30 hrs</strong></p>\r\n\r\n<p><strong>Lugar: C&oacute;mputo 2</strong></p>\r\n\r\n<p><strong>Objetivo del Taller</strong></p>\r\n\r\n<p>El curso est&aacute; dirigido a dise&ntilde;adores sin conocimientos de programaci&oacute;n o p&uacute;blico general que tenga la necesidad de crearse un sitio web, vers&aacute;til sin complicaciones.</p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p><strong>CONTENIDO TEM&Aacute;TICO GENERAL:</strong></p>\r\n\r\n<ul>\r\n	<li>Instalaci&oacute;n autom&aacute;tica de Wordpress (Cpanel)</li>\r\n	<li>Configuraci&oacute;n b&aacute;sica</li>\r\n	<li>Instalaci&oacute;n y gesti&oacute;n de temas</li>\r\n	<li>Dise&ntilde;o de la portada</li>\r\n	<li>Dise&ntilde;o y configuraci&oacute;n del men&uacute;</li>\r\n	<li>Configuraci&oacute;n de los Widgets</li>\r\n	<li>Configuraci&oacute;n y gesti&oacute;n de usuarios</li>\r\n	<li>Configuraci&oacute;n de plugins indispensables</li>\r\n	<li>Introducci&oacute;n al editor Gutenberg</li>\r\n</ul>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p><strong>Requisitos para tomar el Taller:</strong></p>\r\n\r\n<ul>\r\n	<li>Computadora m&iacute;nimo 8gb ram</li>\r\n	<li>Acceso a Internet m&iacute;nimo 5mb velocidad</li>\r\n	<li>Opcional. Web server con cpanel.</li>\r\n	<li>Software Figma versi&oacute;n gratuita</li>\r\n</ul>', '2025-11-03 08:37:12.186108', 4, 23);
...
(10, 'participante', 'pending', '2025-11-11 07:41:49.524884', NULL, 4, NULL, 24, 8, 'jorge996650@gmail.com');
...
(3, '21070040', '2025-11-11 07:41:49.528907', 4, 1, 24);
...
('l2aqlk1fv3widn8utotgpdt6dxmr5ndc', '.eJxVjM0OwiAQhN-FsyEsEGQ9evcZyC4_UjWQlPZkfHfbpAed43zfzFsEWpca1pHnMCVxEVqcfjum-MxtB-lB7d5l7G2ZJ5a7Ig865K2n_Loe7t9BpVG3NYCOqAkZIWLGxGzUFkCLtjjgosgb8FY5TZmYVIxk4eyNcbkUVcTnC897N7Q:1vIrai:MySQuQJhixa1WFOmxZfEFNksFF3ahIxttVlM6NK7iXg', '2025-11-25 16:51:36.195776'),
